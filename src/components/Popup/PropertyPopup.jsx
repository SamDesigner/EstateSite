...
const PropertyPopup = ({ data }) => {
  ...
  return (
    <div onClick={close} className="bg-[rgba(0,0,0,0.8)]  h-full w-full fixed top-0 left-0 z-[500] flex items-center justify-center">
      ...
      <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-[10px] h-[80vh] w-[70%] flex items-center justify-center ">
          ...
          {data &&
            data.map((dataItem, index) => (
              <SwiperSlide key={index}>
                <img
                  className=" object-cover w-[80%] mx-auto rounded-[10px]"
